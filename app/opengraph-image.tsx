  ...
  return new ImageResponse(
    <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "space-between", padding: 72, color: "white", background: "radial-gradient(circle at 82% 18%, rgba(18,175,124,.42), transparent 30%), linear-gradient(135deg,#10213F,#1A2E59 58%,#12AF7C)" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", maxWidth: 1000 }}>
        ...
        <div style={{ marginTop: 28, fontSize: 25, color: "#cbd5e1" }}>Payments, banking services and digital financial solutions in one connected ecosystem.</div>
      </div>
      <div style={{ fontSize: 18, letterSpacing: 4, textTransform: "uppercase", color: "#76DDB9" }}>Payments · Banking Services · Digital Financial Solutions</div>
    </div>,
    size,
  );
}
