              ...
              <div className="mt-6 grid gap-3 sm:grid-cols-3 xl:grid-cols-1 2xl:grid-cols-3">
                {[
                  ...
                  return (
                    ...
                    {/* REPLACE the current outer form wrapper with this */}
                    <div className="relative isolate overflow-hidden rounded-[32px] border border-slate-200/80 bg-white p-5 shadow-[0_28px_90px_-55px_rgba(8,18,37,.45)] dark:border-white/[.09] dark:bg-[#0b1118] sm:p-7 lg:p-9">
                        ...
                        {/* ADD THIS BACKGROUND GRAPHIC BLOCK */}
                        <div
                            aria-hidden="true"
                        ...
                        >
                            ...
                            <div
                                ...
                                style={{
                                    backgroundImage:
                                        "radial-gradient(circle, rgba(18,175,124,.32) 1px, transparent 1px)",
                                    backgroundSize: "26px 26px",
                                }}
                            />

                            {/* Payment/network graphic */}
                            <svg
                                viewBox="0 0 900 1100"
                                fill="none"
                                className="absolute right-[-140px] top-[100px] h-[760px] w-[620px] opacity-[0.20] dark:opacity-[0.14]"
                            >
                                <defs>
                                    <linearGradient
                                        id="partnerNetworkGradient"
                                        x1="0"
                                        y1="0"
                                        x2="900"
                                        y2="1100"
                                    ...
                                    <radialGradient id="partnerNodeGradient">
                                        <stop offset="0" stopColor="#12AF7C" stopOpacity="0.85" />
                                        <stop offset="1" stopColor="#12AF7C" stopOpacity="0" />
                                    </radialGradient>
                                </defs>

                                {/* Connection paths */}
                                <path
                                    d="M100 170C230 60 355 120 430 250C525 410 690 342 810 220"
                                    stroke="url(#partnerNetworkGradient)"
                                    strokeWidth="2"
                                    strokeDasharray="8 10"
                                />

                                <path
                                    d="M75 520C220 395 325 445 420 570C515 690 650 670 800 540"
                                    stroke="url(#partnerNetworkGradient)"
                                    strokeWidth="2"
                                ...
                                <path
                                    d="M160 860C265 760 350 760 450 850C565 955 670 935 785 820"
                                    stroke="url(#partnerNetworkGradient)"
                                    strokeWidth="2"
                                ...
                                <path
                                    d="M430 250C390 375 392 450 420 570"
                                    stroke="url(#partnerNetworkGradient)"
                                    strokeWidth="1.5"
                                />

                                <path
                                    d="M420 570C405 690 420 760 450 850"
                                    stroke="url(#partnerNetworkGradient)"
                                    strokeWidth="1.5"
                                />

                                {/* Large soft nodes */}
                                <circle cx="430" cy="250" r="88" fill="url(#partnerNodeGradient)" />
                                <circle cx="420" cy="570" r="100" fill="url(#partnerNodeGradient)" />
                                <circle cx="450" cy="850" r="76" fill="url(#partnerNodeGradient)" />
                            ...
                            {/* Decorative card / transaction graphics */}
                            <div className="absolute left-[4%] top-[34%] hidden rotate-[-8deg] opacity-[0.15] xl:block dark:opacity-[0.10]">
                                <div className="h-32 w-48 rounded-[24px] border border-brand-400/40 bg-gradient-to-br from-brand-300/20 to-cyan-300/10 p-5">
                                    <div className="flex items-center justify-between">
                                        <div className="h-8 w-8 rounded-full border border-brand-400/50" />
                                        <div className="h-2 w-12 rounded-full bg-brand-400/30" />
                                    </div>
                                    <div className="mt-8 h-2 w-24 rounded-full bg-slate-400/20" />
                                    <div className="mt-3 h-2 w-16 rounded-full bg-brand-400/30" />
                                </div>
                            </div>

                            {/* Edge fades so graphics never disturb fields */}
                            <div className="absolute inset-x-0 top-0 h-40 bg-gradient-to-b from-white via-white/70 to-transparent dark:from-[#0b1118] dark:via-[#0b1118]/80" />
                            <div className="absolute inset-x-0 bottom-0 h-40 bg-gradient-to-t from-white via-white/75 to-transparent dark:from-[#0b1118] dark:via-[#0b1118]/80" />
                        </div>

                        {/* REPLACE your existing form header div class with this */}
                        ...
                        {/* REPLACE ONLY the className of your existing <form> with this */}
                        <form
